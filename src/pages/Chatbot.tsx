...
const initialMessages = [
  {
    sender: "bot",
    text: "Hi! I'm your library assistant. How can I help you today?",
  },
];
    ...
    <>
      ...
      <StructuredData
        ...
        data={{
          ...
          description:
            "AI-powered chatbot for library help, resources, and support.",
          url: "https://nkrlibrary.com/chatbot",
        }}
      />
            ...
            {messages.map((msg, i) => (
              ...
              >
                <div
                  ...
                  aria-label={
                    msg.sender === "user" ? t("yourMessage") : t("botMessage")
                  }
                >
                  {msg.text}
                </div>
