...
const PrivacyPolicy: React.FC = () => (
  <main className="container mx-auto px-4 py-8 max-w-3xl">
    ...
    <p className="mb-4">
      This Privacy Policy explains how NKR Library collects, uses, and protects
    ...
    <p className="mb-4">
      We use third-party services such as Google AdSense, which may collect
      information via cookies and similar technologies. Please review their
      privacy policies for more details.
    </p>
    <h2 className="text-xl font-semibold mt-6 mb-2">Your Choices</h2>
    <p className="mb-4">
      You can manage cookies through your browser settings. For questions about
