...
import { Eye, Brain, Handshake } from "lucide-react";
          ...
          >
            {visionItems.map((item, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <MagneticCard intensity={0.25} scale={1.06} className="h-full">
                  <motion.div
                    whileHover={{
                  ...
                  >
                    <Card
                      className={`h-full border border-border hover:border-primary/30 transition-all duration-500 hover:shadow-2xl bg-gradient-to-br ${item.gradient} backdrop-blur-sm`}
                    >
