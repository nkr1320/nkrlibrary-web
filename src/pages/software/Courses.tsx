...
const Courses = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      icon: Palette,
      description:
        "Learn design principles, prototyping, and user experience best practices",
      duration: "8 weeks",
      lessons: 24,
      students: 645,
      level: "Beginner",
    ...
    },
    {
      ...
      icon: Database,
      description:
        "Master SQL, database design, and data management techniques",
      duration: "6 weeks",
      lessons: 28,
      students: 520,
      level: "Intermediate",
    ...
    },
    {
      ...
      icon: BookOpen,
      description:
        "Essential CS concepts including algorithms and data structures",
      duration: "16 weeks",
      lessons: 60,
      students: 780,
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Comprehensive learning paths designed for students. Master
            programming, design, and technology with project-based courses and
        ...
        <motion.div variants={itemVariants} className="mb-12">
          <Card>
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Structured course sequences designed to build expertise in
                specific areas
              </p>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of students building their careers through
                practical, project-based learning. All courses are completely
                free and designed for real-world success.
              </p>
