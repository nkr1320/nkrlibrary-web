...
import { Smartphone, AlertTriangle, Mail, KeyRound } from "lucide-react";
  ...
  const risks = [
    {
      title: "Data Theft",
      description:
        "Personal messages, photos, and contacts can be stolen and misused",
    },
    {
      title: "Account Ban",
      description:
        "WhatsApp may permanently ban accounts using unofficial versions",
    },
    {
    ...
    },
    {
      ...
      description:
        "No guarantee that your private conversations remain private",
    },
    {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about the security risks of GB WhatsApp and other unofficial messaging apps. Complete guide on safe messaging practices."
        />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Understand the serious security risks of using unofficial
                WhatsApp modifications and protect your data.
              </p>
            </motion.div>
              ...
              <Card className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold mb-4 text-destructive">
                    Why GB WhatsApp is Dangerous
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    GB WhatsApp and similar unofficial apps may offer extra
                    features, but they come with serious security risks. These
                    modified apps are not developed by WhatsApp and can
                    compromise your privacy, security, and device safety.
                  </p>
              ...
              <Card className="border border-primary/30 bg-primary/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Instead of using unofficial apps, consider these safe
                    alternatives for enhanced messaging features:
                  </p>
              ...
              <Card className="border border-border bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    If you think your device may be compromised, get help
                    immediately to secure your accounts and data.
                  </p>
