...
const Blog3: React.FC = () => (
  <main className="container mx-auto px-4 py-8 max-w-3xl">
    ...
    />
    <h1 className="text-3xl font-bold mb-4">Blog 3: Protect Yourself from Cyber Scams</h1>
    <p className="mb-4">
      As our lives become more digital, cyber scams are becoming increasingly common. From phishing emails to fake apps, it’s important to stay informed and vigilant to protect your personal information and finances.
    </p>
    <div className="my-6">
      <iframe
        width="100%"
    ...
    <h2 className="text-xl font-semibold mt-6 mb-2">Common Scams to Watch For</h2>
    <ul className="list-disc ml-6 mb-4">
      ...
      <li>Fake apps like GB WhatsApp: Why you should avoid unofficial downloads</li>
      <li>Data breach protection: Monitoring your accounts for unusual activity</li>
    ...
    <p className="mb-4">
      Digital safety is everyone’s responsibility. Share these tips with friends and family, and explore our video guides for more ways to stay protected online.
    </p>
    ...
    <ul className="list-disc ml-6 mb-4">
      ...
      <li><a href="/blog9" className="text-blue-600 underline">How to Spot Phishing and Email Scams</a></li>
    </ul>
  </main>
);
