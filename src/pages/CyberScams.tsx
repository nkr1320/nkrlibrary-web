...
const CyberScams = () => {
  ...
  const scamDetails = [
    {
      ...
      severity: "high",
      description:
        "Personal information theft through data breaches, unsecured databases, and identity fraud.",
      prevention: [
    ...
    },
    {
      ...
      severity: "high",
      description:
        "Fraudsters create fake romantic relationships to exploit emotions and steal money or information.",
      prevention: [
    ...
    },
    {
      ...
      severity: "critical",
      description:
        "Fake emails, websites, and messages designed to steal login credentials and sensitive information.",
      prevention: [
    ...
    },
    {
      ...
      severity: "critical",
      description:
        "Malicious software, ransomware, and system attacks that can damage devices and steal data.",
      prevention: [
    ...
    },
    {
      ...
      severity: "high",
      description:
        "Criminals threaten to share intimate content unless victims pay money or provide more content.",
      prevention: [
    ...
    },
    {
      ...
      severity: "medium",
      description:
        "Scam calls impersonating banks, government agencies, or tech support to steal information or money.",
      prevention: [
  ...
  return (
    <>
      {/* Unique SEO meta tags for CyberScams page */}
      <SEOHead
        title="Cyber Scams & Digital Safety | NKR Library"
        description="Comprehensive guide to staying safe online. Learn about cyber scams, prevention strategies, and emergency response procedures from NKR Library."
      />
      <HelmetProvider>
        <Helmet>
          ...
          <meta
            name="description"
            content="Comprehensive guide to staying safe online. Learn about cyber scams, prevention strategies, and emergency response procedures from NKR Library."
          />
          <meta
            name="keywords"
            content="cyber security, digital safety, scam awareness, phishing, malware, online fraud, data protection"
          />
        </Helmet>
            ...
            >
              ...
              <motion.div variants={itemVariants} className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                  Stay protected in the digital world. Learn to identify,
                  prevent, and respond to cyber threats with our comprehensive
                  safety guide.
                </p>
              </motion.div>
                          ...
                          <CardContent className="p-8">
                            <div className="flex flex-col lg:flex-row gap-6">
                              ...
                              <div className="flex items-start gap-4 lg:w-1/3">
                                ...
                                >
                                  <scam.icon
                                    className={`text-3xl ${getSeverityColor(scam.severity)}`}
                                  />
                                </motion.div>
                                <div>
                              ...
                              <div className="lg:w-2/3 grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                  ...
                                  <ul className="space-y-2">
                                    {scam.warning_signs.map(
                                      (sign, signIndex) => (
                                        <li
                                          key={signIndex}
                                          className="flex items-start text-sm"
                                        >
                                          <AlertTriangle className="text-orange-500 mr-2 mt-0.5 flex-shrink-0 text-xs" />
                                          {sign}
                                        </li>
                                      ),
                                    )}
              ...
              <motion.div variants={itemVariants} className="mb-16">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {emergencySteps.map((emergency, index) => (
                    <Card
                      key={index}
                      className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm"
                    >
                ...
                <Card className="border border-border bg-card/80 backdrop-blur-sm">
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                      If you've encountered a scam or need additional guidance
                      on digital safety, don't hesitate to reach out or check
                    ...
                    <div className="mt-8 p-4 bg-accent/10 rounded-lg">
                      <p className="text-sm text-muted-foreground">
                        <strong>Emergency:</strong> If you're experiencing
                        immediate financial fraud, contact your bank and local
