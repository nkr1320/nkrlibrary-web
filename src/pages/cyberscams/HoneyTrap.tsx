...
import { SentimentVeryDissatisfied, ArrowBack, CheckCircle, Warning, Shield } from '@mui/icons-material';
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta name="description" content="Learn to identify and protect yourself from romance scams and honey trap frauds. Complete guide on prevention and response strategies." />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <SentimentVeryDissatisfied className="text-4xl sm:text-5xl text-destructive mr-4" />
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Learn to identify and protect yourself from romance scams and emotional manipulation online.
              </p>
            </motion.div>
            ...
            >
              <Card className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold mb-4 text-destructive">What Are Honey Trap Scams?</h2>
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Honey trap scams involve fraudsters creating fake romantic relationships to exploit victims emotionally 
                    and financially. Scammers build trust over time, then request money for various emergencies or reasons.
                  </p>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-4 bg-card rounded-lg">
                      <h3 className="font-semibold mb-2">Emotional Manipulation</h3>
                      <p className="text-sm text-muted-foreground">Building fake emotional connections</p>
                    </div>
                    <div className="p-4 bg-card rounded-lg">
                      <h3 className="font-semibold mb-2">Financial Exploitation</h3>
                      <p className="text-sm text-muted-foreground">Requesting money for emergencies</p>
                    </div>
                    <div className="p-4 bg-card rounded-lg">
                      <h3 className="font-semibold mb-2">Identity Theft</h3>
                      <p className="text-sm text-muted-foreground">Stealing personal information</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              <Card className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold mb-6 text-destructive">If You've Been Targeted</h2>
              ...
              <Card className="border border-border bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    If you've been a victim of a romance scam, remember that it's not your fault. Seek support and report the crime.
                  </p>
