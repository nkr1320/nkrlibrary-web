  ...
  const phishingTypes = [
    {
      ...
      description:
        "Fake emails impersonating legitimate companies to steal credentials",
    },
    {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn to identify and protect yourself from phishing attacks. Complete guide on email security and fraud prevention."
        />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <Mail className="text-4xl sm:text-5xl text-destructive mr-4" />
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Protect yourself from fraudulent emails, websites, and messages
              ...
              <Card className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    ...
                    that appear to come from legitimate sources to trick you
                    into revealing sensitive information like passwords, credit
              ...
              <Card className="border border-border bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    <KeyRound className="text-green-500 text-3xl mr-3" />
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {preventionTips.map((tip, index) => (
                      ...
                      >
                        <KeyRound className="text-green-500 mr-3 flex-shrink-0" />
              ...
              <Card className="border border-border bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    If you think you've fallen victim to a phishing attack, act
                    quickly to secure your accounts.
                  </p>
