...
const CyberAttacks = () => {
  ...
  const attackTypes = [
    ...
    },
    {
      title: "Trojans",
      description:
        "Programs that appear legitimate but contain hidden malicious code",
    },
    {
      title: "Spyware",
      description:
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn to protect your devices from cyber attacks, malware, and system threats. Complete security guide and prevention strategies."
        />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <Bug className="text-4xl sm:text-5xl text-destructive mr-4" />
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Protect your devices and data from malicious software,
                ransomware, and system attacks.
              </p>
            </motion.div>
              ...
              <Card className="border border-destructive/30 bg-destructive/5 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Cyber attacks involve malicious attempts to damage, disable,
                    or gain unauthorized access to computer systems, networks,
                    or devices. These attacks can result in data theft,
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {preventionTips.map((tip, index) => (
                      ...
                      >
                        <Shield className="text-green-500 mr-3 flex-shrink-0" />
              ...
              <Card className="border border-border bg-card/80 backdrop-blur-sm">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    If you're dealing with a serious cyber attack, don't
