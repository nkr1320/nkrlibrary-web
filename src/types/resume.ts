...
export type ResumeAction =
  ...
  | {
      type: "UPDATE_PROJECT";
      payload: { id: string; data: Partial<ResumeData["projects"][0]> };
    }
  | { type: "REMOVE_PROJECT"; payload: string }
  | { type: "ADD_CERTIFICATION"; payload: ResumeData["certifications"][0] }
  | {
      type: "UPDATE_CERTIFICATION";
      payload: { id: string; data: Partial<ResumeData["certifications"][0]> };
    }
  ...
  | {
      ...
      payload: { id: string; data: Partial<ResumeData["customSections"][0]> };
    }
  ...
  | {
      type: "SAVE_VERSION";
      payload: { name: string; jobTitle?: string; company?: string };
    }
