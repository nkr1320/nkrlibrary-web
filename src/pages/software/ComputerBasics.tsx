  ...
  const topics = [
    {
      ...
      icon: Monitor,
      description: "Learn to optimize your screen resolution, brightness, and multi-monitor setup",
      skills: ["Resolution adjustment", "Color calibration", "Multiple displays", "Screen orientation"],
      difficulty: "Beginner"
    },
    {
      ...
      skills: ["Safe uninstallation", "Program updates", "Registry cleanup", "Startup management"],
      difficulty: "Intermediate"
    },
    {
      title: "Windows Customization",
      icon: Computer,
      description: "Personalize your Windows experience with themes and settings",
      skills: ["Theme installation", "Taskbar customization", "Start menu", "Desktop widgets"],
      difficulty: "Beginner"
    },
    {
      ...
      skills: ["Speed monitoring", "Network troubleshooting", "Performance tuning", "System maintenance"],
      difficulty: "Advanced"
    }
  ];
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Master fundamental computer skills from display settings to system optimization. 
            Build confidence with hands-on tutorials and practical knowledge.
          </p>
        </motion.div>
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of students who have mastered computer basics through our practical, 
                hands-on approach. Start with the fundamentals and build your confidence.
              </p>
