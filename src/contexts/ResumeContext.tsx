...
import { ResumeData, ResumeState, ResumeAction, initialState } from '@/types/resume';
...
export const ResumeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  console.log('ResumeProvider: State initialized', state);
  console.log('ResumeProvider: Initial resume data:', state.resumeData);
  ...
  const contextValue: ResumeContextType = {
    ...
    addExperience: (data) => {
      dispatch({ type: 'ADD_EXPERIENCE', payload: { ...data, id: Date.now().toString() } });
    },
    ...
    addEducation: (data) => {
      dispatch({ type: 'ADD_EDUCATION', payload: { ...data, id: Date.now().toString() } });
    },
    ...
    addProject: (data) => {
      dispatch({ type: 'ADD_PROJECT', payload: { ...data, id: Date.now().toString() } });
    },
    ...
    addCertification: (data) => {
      dispatch({ type: 'ADD_CERTIFICATION', payload: { ...data, id: Date.now().toString() } });
    },
  ...
  console.log('ResumeProvider: Providing context value', contextValue);
  console.log('ResumeProvider: About to render with context');
...
export const useResume = () => {
  console.log('useResume: Attempting to get context...');
  console.log('useResume: ResumeContext reference:', ResumeContext);
  const context = useContext(ResumeContext);
  console.log('useResume: Context value:', context);
  console.log('useResume: useContext function:', useContext);
  
  if (context === undefined) {
    console.error('useResume: Context is undefined! Provider not found.');
    console.error('useResume: This suggests SentrumResume is rendered outside ResumeProvider tree');
    throw new Error('useResume must be used within a ResumeProvider');
  }
  console.log('useResume: Context found successfully');
  return context;
};