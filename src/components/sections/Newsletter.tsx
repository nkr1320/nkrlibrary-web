                  ...
                  <div className="text-center max-w-2xl mx-auto px-4">
                    ...
                    {status !== "idle" && (
                      ...
                      >
                        <Alert
                          ...
                          icon={
                            status === "success" ? <CheckCircle /> : undefined
                          }
                        >
                          {message}
                        </Alert>
                    ...
                    >
                      <input
                        ...
                        className="flex-1 p-3 border border-primary/20 rounded-md focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary"
                      />
                      ...
                      <MagneticCard intensity={0.15} scale={1.05}>
                        <Button
                          ...
                          variant="contained"
                          size="large"
                          className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2.5 rounded-md text-lg font-semibold transition-colors"
                        >
