...
export const getCriticalVideos = (): Video[] => {
  ...
  return [
    ...
    { id: '15', title: 'Medical Coding Course Part 1', url: 'https://www.youtube.com/watch?v=N7jZxShJ3uI', category: 'Medical', year: '2024' },
    { id: '29', title: 'Be Aware of Sextortion and Blackmail Scams', url: 'https://www.youtube.com/watch?v=FAYfRD9jnDs', category: 'CyberScams', year: '2024' },
    { id: '45', title: 'DeepSeek AI - Trump Warns of Wake-up Call', url: 'https://www.youtube.com/watch?v=tS-m7CiAwSM', category: 'Science', year: '2025' },
    { id: '49', title: 'How to Add Upwork Withdrawal Bank Account', url: 'https://www.youtube.com/watch?v=093smeLTJ50', category: 'Career', year: '2024' },
  ];
};
