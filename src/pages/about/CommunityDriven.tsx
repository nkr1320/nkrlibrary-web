      ...
      >
        ...
        >
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Students learn together, share experiences, and help each other
                grow. Peer-to-peer learning accelerates understanding.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Everyone contributes to the community's success. Share
                knowledge, help others, and grow together.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Welcoming space for learners of all backgrounds and skill
                levels. Diversity makes our community stronger.
              </p>
            </CardContent>
          </Card>
        </motion.div>
